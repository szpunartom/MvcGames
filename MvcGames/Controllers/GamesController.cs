...
namespace MvcGames.Controllers
{
    public class GamesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,Platforms,ReleaseDate,Genre,Developer,Publisher")] Game game)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,Platforms,ReleaseDate,Genre,Developer,Publisher")] Game game)
        {
            if (id != game.Id)
            {
                return NotFound();
